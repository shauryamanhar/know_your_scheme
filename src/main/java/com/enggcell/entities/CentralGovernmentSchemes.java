 ...
 */
@Entity
@Table(name = "centralGovernmentSchemes")
@SequenceGenerator(name = "centralGovernmentSchemes_seq", sequenceName = "centralGovernmentSchemes_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "CentralGovernmentSchemes.findAll", query = "SELECT r FROM CentralGovernmentSchemes r")})
public class CentralGovernmentSchemes implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @NotNull
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "centralGovernmentSchemes_seq")
    @Column(name = "id")
    private Long id;
    ...
    public CentralGovernmentSchemes() {
    }

    public CentralGovernmentSchemes(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CentralGovernmentSchemes)) {
            return false;
        }
        CentralGovernmentSchemes other = (CentralGovernmentSchemes) object;
