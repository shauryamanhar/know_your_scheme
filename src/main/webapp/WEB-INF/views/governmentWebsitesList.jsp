...
if(session.getAttribute("knowYourSchemeUser") == null){
	if(request.getAttribute("listOfGovernmentWebsites") != null &&
  ...
  <div class="block-content content"><div class="view view-most-search view-id-most_search view-display-id-block view-dom-id-e38b830996d06758e7d3042e35592d38">
	  ...
	  <!-- !Breadcrumbs -->
		<div class="bread_crumbs" > 
			<div class='wrapper'><a href="<%=request.getContextPath() %>/">Home</a><a href="<%=request.getContextPath()%>/schemes/">Schemes</a>Government-Wesites</div>		</div> 
        <div class="content-inner wrapper">	
			<!-- !Messages and Help -->
									<div class="full_width_secction" style = "width: 100%;">
			  
								  <h1 class="static_page_head">Government Websites</h1>
