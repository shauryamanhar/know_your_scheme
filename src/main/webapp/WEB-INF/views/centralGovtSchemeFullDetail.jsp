...
CentralGovernmentSchemes centralGovernmentSchemeFullDetail = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	if(request.getAttribute("listOfCentralGovernmentSchemesCategory") != null &&
			   ...
			   request.getAttribute("centralGovernmentSchemeFullDetail") != null &&
			   !request.getAttribute("centralGovernmentSchemeFullDetail").equals("")){
				...
				centralGovernmentSchemeFullDetail = (CentralGovernmentSchemes)request.getAttribute("centralGovernmentSchemeFullDetail");
			}
}else{
      ...
      <main id="content-column" class="content-column" role="main">
        <div class="content-inner">
          ...
          <div id="main-content">
           ...
           if(centralGovernmentSchemeFullDetail != null){
        %>
        <br>
        <div class = "container">
            <div class = "row">
            ...
            <br>
            <div class = ""><h1><%=centralGovernmentSchemeFullDetail.getSchemeName() %></h1></div>
            <br>
            <br>
            <div><img src = "<%=centralGovernmentSchemeFullDetail.getImageLink()%>"></div>
            <br>
            <div style = "font-size:15px;">
               <%=centralGovernmentSchemeFullDetail.getDetailedInfo() %>
            </div>
            </div>
            </div>
        </div>
