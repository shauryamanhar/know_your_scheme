...
List<String> visualisationCategory = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	...
	if(request.getAttribute("statesForUrl") != null &&
	   ...
	   !request.getAttribute("mapOfVisualisationWithUrl").equals("")){
		...
		visualisationCategory = (List<String>)request.getAttribute("visualisationCategory");
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 if(visualisationCategory != null){
							 for(String schemeCat : visualisationCategory){
								    	 %>
								    	 <li><a href="<%=request.getContextPath()%>/schemes/visualisation/categories/<%=schemeCat %>"><%=mapOfVisualisationWithUrl.get(schemeCat) %></a></li>
								    	 <%
						     }
						  }
