...
<%
List<GovernmentJobs> listOfGovernmentJobs = null;
User user = null;
List<News> news = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	...
	if(request.getAttribute("listOfGovernmentJobs") != null &&
	   !request.getAttribute("listOfGovernmentJobs").equals("")){
		listOfGovernmentJobs = (List<GovernmentJobs>)request.getAttribute("listOfGovernmentJobs");
	}	
}else{
	...
	if(request.getAttribute("dashboardUser") != null &&
	   ...
	   request.getAttribute("listOfGovernmentJobs") != null &&
	   !request.getAttribute("listOfGovernmentJobs").equals("")){
  ...
  <div class="block-content content"><div class="view view-most-search view-id-most_search view-display-id-block view-dom-id-e38b830996d06758e7d3042e35592d38">
	  ...
	  <!-- !Breadcrumbs -->
		<div class="bread_crumbs" > 
			<div class='wrapper'><a href="<%=request.getContextPath() %>/">Home</a><a href="<%=request.getContextPath()%>/schemes/">Schemes</a>Government-Jobs</div>		</div> 
        <div class="content-inner wrapper">	
			<!-- !Messages and Help -->
									<div class="full_width_secction" style = "width: 100%;">
			  
								  <h1 class="static_page_head">Government Jobs</h1>
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 <div id="block-system-main" class="block block-system no-title" >          <div class="three-25-50-25 at-panel panel-display clearfix" >     <div style = "width: 100%!important;" class="region region-three-25-50-25-first">     <div class="region-inner clearfix">       <div class="panel-pane pane-block pane-npi-utility-left-menu-siblings left_sidebar test2 no-title block">    <div class="block-inner clearfix">                                <div class="block-content" style = "width:100%;">        <div class="topic" id="leftside-bar">  					<div class="sidebar_head"><i class="fa fa-sitemap"></i><span style = "width:100%;"> Government Jobs </span></div>
						 <ul>
						 <%
						 if(listOfGovernmentJobs != null){
							 for(GovernmentJobs governmentJobs : listOfGovernmentJobs){
									 %>
									 <li><a role="link" href="<%=request.getContextPath()%>/schemes/Government-Jobs/<%=governmentJobs.getGovernmentJobHeadline()%>/<%=governmentJobs.getUpdatedDate()%>"><%=governmentJobs.getGovernmentJobHeadline() %></a></li>
									 <% 
							 }
						 }
