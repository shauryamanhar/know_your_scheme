			...
			<div class="col-lg-12 col-md-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							<td><%=++i %></td>
							<td><%=applicationForm.getApplicationHeadline() %></td>
							<td><a href = "<%=applicationForm.getApplicationPageLink() %>"><%=applicationForm.getApplicationPageLink() %></a></td>
							<td><%=applicationForm.getAddedDate() %></td>
							<td><%=applicationForm.getActualLastModifiedDate() %></td>
						</tr>
						<%
						}
						%>
