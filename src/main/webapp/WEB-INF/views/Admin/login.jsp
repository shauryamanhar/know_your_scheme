...
function isMyValidForm(){
    ...
    $.ajax({
    	async: false,
		type: "POST",
		url: "<%= request.getContextPath()%>/admin/signin/validate",
...
<br>
<h2><span style = "font-weight:bold;">Admin, </span>Know Your Scheme</h2>
    ...
    <div class="form-wrap">
		<div class="tabs">
			<h3 class="login-tab"><span class="active" href="#login-tab-content" style = "margin-top: -20px; text-decoration: none;">Login</span></h3>
		</div><!--.tabs-->

		<div class="tabs-content">
			<div id="login-tab-content" class="active">
				<form class="login-form" action="<%=request.getContextPath() %>/admin/dashboard" method="post" onsubmit="return isMyValidForm();">
