			...
			<div class="col-lg-12 col-md-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<%
						int i = 0;
						for(GovernmentJobs governmentJob : listOfGovernmentJpbs){
						%>
						<tr>
							<td><%=++i %></td>
							<td><%=governmentJob.getGovernmentJobHeadline() %></td>
							<td><a href = "<%=governmentJob.getGoveernmentJobPageLink() %>"><%=governmentJob.getGoveernmentJobPageLink()%></a></td>
							<td><%=governmentJob.getAddedDate() %></td>
							<td><%=governmentJob.getActualLastModifiedDate() %></td>
						</tr>
						<%
						}
						%>
