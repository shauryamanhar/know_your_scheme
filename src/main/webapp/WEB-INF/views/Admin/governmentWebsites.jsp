			...
			<div class="col-lg-12 col-md-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							<td><%=++i %></td>
							<td><%=governmentWebsite.getGovernmentWebsitesHeadline() %></td>
							<td><a href = "<%=governmentWebsite.getGovernmentWebsitesPageLink() %>"><%=governmentWebsite.getGovernmentWebsitesPageLink()%></a></td>
							<td><%=governmentWebsite.getAddedDate() %></td>
							<td><%=governmentWebsite.getActualLastModifiedDate() %></td>
						</tr>
						<%
						}
						%>
