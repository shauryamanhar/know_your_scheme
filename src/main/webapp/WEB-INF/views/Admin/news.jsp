			...
			<div class="col-lg-12 col-md-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							<td><%=++i %></td>
							<td><%=newsOne.getNewsHeadline() %></td>
							<td><a href = "<%=newsOne.getNewsLink() %>"><%=newsOne.getNewsLink() %></a></td>
							<td><%=newsOne.getNewsSummary() %></td>
							<td><%=newsOne.getTypeOfNews() %></td>
							<td><%=newsOne.getImageUrl() %></td>
							<td><%=newsOne.getAddedDate() %></td>
							<td><%=newsOne.getNewsDate() %></td>
						</tr>
						<%
						}
						%>
