...
<a href="index.html" class="loginlinks">Sign In</a>
<a href="index.html" class="loginlinks">Register</a>
...
%>
<a target="_blank" href="hi/index.html" class="alink" title="हिन्दी site open in new window"><%="हिन्दी "  %></a>
</div></div>
  </div></div></div></div>		</div>
	</section>
	<section class="header_middle" style = "background-color:beige;">
		<div class="wrapper">
        			  <div id="logo">
				 <a href="index.html"><h2 style = "font-size: 33px; margin-top: 30px; font-weight: bold;">KnowYourScheme</h2></a>
			  </div>
			              <a class="mobileNav" href="javascript:;"><span></span><span></span><span></span></a>
 ...
 <%
 //<span class="fa fa-pagelines"></span><a href="<%=request.getContextPath() /assets/topics/agriculture.html">Agriculture</a></li>
 %>           
    
    <div class="block-content">
          <nav>
<ul id="nav">
  <li class="topics"><a href="topics.html" class="topicsLink"><img src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/nav1.png" alt="nav1"><span>Schemes</span></a>
   
  <ul>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/Central-Government/Rural Schemes">Central Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/arunachal-pradesh-govt-schemes">Arunachal Pradesh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/andhra-pradesh-govt-schemes">Andhra Pradesh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/assam-govt-schemes">Assam Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/bihar-govt-schemes">Bihar Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/chhattisgarh-govt-schemes">Chhattisgarh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/delhi-govt-schemes">Delhi Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/haryana-govt-schemes">Haryana Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/himachal-pradesh-govt-schemes">Himachal Pradesh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/jharkhand-govt-schemes">Jharkhand Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/karnataka-govt-schemes">Karnataka Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/kerala-govt-schemes">Kerala Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/madhya-pradesh-govt-schemes">Madhya Pradesh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/maharashtra-govt-schemes">Maharastra Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/mizoram-govt-schemes">Mizoram Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/manipur-govt-schemes">Manipur Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/meghalaya-govt-schemes">Meghalaya Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/nagaland-govt-schemes">Nagaland Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/odisha-govt-schemes">Odisha Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/punjab-govt-schemes">Punjab Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/rajasthan-govt-schemes">Rajasthan Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/sikkim-govt-schemes">Sikkim Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/tamil-nadu-govt-schemes">Tamil Nadu Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/telangana-govt-schemes">Telangana Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/tripura-govt-schemes">Tripura Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/uttarakhand-govt-schemes">Uttarakhand Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/uttar-pradesh-govt-schemes">Uttar Pradesh Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/west-bengal-govt-schemes">West Bengal Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/State-Government/pradhan-mantri-yojana-govt-schemes">Pradhan Mantri Yojana Government Schemes</a></li>
    </ul>
  </li>
  <li class="how"><a href="http://services.india.gov.in/"  target="_BLANK" title="External Website that opens in a new window" class="howDiID"><img src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/nav2.png" alt="nav2"><span>Site Map</span></a></li>
  <li class="government"><a href="my-government.html" class="myGovt"><img src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/nav3.png" alt="nav3"><span>My Government</span></a></li>
  <li class="people"><a href="<%=request.getContextPath() %>/assets/people-groups.html" class="peopleGroups"><img src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/nav4.png" alt="nav4"><span>About Us</span></a></li>
  <li class="egov"><a href="<%=request.getContextPath() %>/assets/india-glance.html" class="indGlance"><img src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/nav5.png" alt="nav5"><span>Contact Us</span></a></li>  
</ul>
</nav>
    </div>
    ...
    <section class="header_botton" style = "background:none; background-color: #8bc34a;">
		<div class="wrapper">
...
<div id="auto_suggesion"></div>
 ...
 <select id="edit-sort-order" name="sort_order" class="form-select"><option value="ASC">Asc</option><option value="DESC" selected="selected">Desc</option></select>
  ...
  <div class="block-content content"><div class="view view-home-main-slider view-id-home_main_slider view-display-id-block jquery-slider-wrapper jquery-slider-option-navigation-selector-control-timer view-dom-id-206eb86a024ae4b7146f97c90941778a">
  ...
  <div class="views-field views-field-php">        <span class="field-content"><img src="https://cbpssubscriber.mygov.in/assets/uploads/flYHd7E7b2W2XRtP" id="_9dlO5d9OlWeVIZCG" onclick="javascript:window.open('https://cbpssubscriber.mygov.in/aff/9dlO5d9OlWeVIZCG')" style="cursor:pointer" onload="javascript:(function(){if(typeof _done == 'undefined' || !_done){this.setAttribute('src', this.getAttribute('src')+'?'+Math.floor((Math.random() * 100) + 1)); _done=true;}}).call(this)" ></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-2 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><a href="spotlight/swadesh-darshan.html" target="_BLANK"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/swadesh-spotlight-.jpg"></a></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-3 views_slideshow_cycle_hidden views-row-odd">
      
  <div class="views-field views-field-php">        <span class="field-content"><a href="http://pib.nic.in/newsite/PrintRelease.aspx?relid=174367" target="_BLANK"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/finance.jpg"></a></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-4 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><a href="http://www.swachhbharaturban.in/sbm/home/#/SBM " target="_BLANK"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/ss_2018.jpg"></a></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-5 views_slideshow_cycle_hidden views-row-odd">
      
  <div class="views-field views-field-php">        <span class="field-content"><a href="http://pib.nic.in/EventDetail.aspx?ID=1076" target="_BLANK"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/end-review17.jpg"></a></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-6 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><a href="http://pmaymis.gov.in/" target="_BLANK"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/pradhan-mantri-awas.jpg"></a></span>  </div>  </li>
    </ul>
  </div>
</div></div>
      </div>
        ...
        <div class="content-inner">
          ...
          <div id="main-content">
            ...
            <!-- !Main Content -->
                ...
                <div id="block-system-main" class="block block-system no-title" >          <div class="one-column at-panel panel-display clearfix" id="home">   <div class="region region-one-main">     <div class="region-inner clearfix">       <div class="panel-pane pane-panels-mini pane-home-main-content wrapper no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="panel-display panel-3col clearfix" id="mini-panel-home_main_content">   <div class="panel-panel panel-col-first">     <div class="inside"><div class="panel-pane pane-custom pane-1 home_heading no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <h2>News Highlights</h2>    </div>                  </div>  </div>  <div class="panel-separator"></div><div class="panel-pane pane-block pane-quicktabs-none no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div  id="quicktabs-_none_" class="quicktabs-wrapper quicktabs-style-nostyle"><div class="item-list item-list-q"><ul class="quicktabs-tabs quicktabs-style-nostyle"><li class="active even first"><a href="homed358.html?qt-_none_=0#qt-_none_" id="quicktabs-tab-_none_-0" class="active">News</a></li><li class="odd last"><a href="home0e2c.html?qt-_none_=1#qt-_none_" id="quicktabs-tab-_none_-1" class="active">Additions to the Portal</a></li></ul></div><div id="quicktabs-container-_none_" class="quicktabs_main quicktabs-style-nostyle"><div  id="quicktabs-tabpage-_none_-0" class="quicktabs-tabpage"><div class="view view-news-feeds view-id-news_feeds view-display-id-block view-dom-id-f9a4bbc875f56772178fe9a00b3a1087">                      <div class="view-content">       <div class="item-list">    <ul>          <li class="views-row views-row-1 views-row-odd views-row-first">             <a href="http://newsonair.nic.in/full_news.asp?TOP1" target="_BLANK" title="External site that opens in a new window">17 killed in fire at cracker factory in Delhi; State govt...</a>   </li>           <li class="views-row views-row-2 views-row-even">             <a href="http://newsonair.nic.in/full_news.asp?TOP2" target="_BLANK" title="External site that opens in a new window">Security agencies, commandos should be trained to tackle cyber...</a>   </li>           <li class="views-row views-row-3 views-row-odd">             <a href="http://newsonair.nic.in/full_news.asp?TOP3" target="_BLANK" title="External site that opens in a new window">NIA begins probe into bomb explosion in Bodh Gaya</a>   </li>           <li class="views-row views-row-4 views-row-even">             <a href="http://newsonair.nic.in/news.asp?cat=National&amp;id=NN16475" target="_BLANK" title="External site that opens in a new window">ONGC acquires 51 pc share of Government in HPCL</a>   </li>           <li class="views-row views-row-5 views-row-odd">             <a href="http://newsonair.nic.in/news.asp?cat=International&amp;id=IN20772" target="_BLANK" title="External site that opens in a new window">Kabul&#039;s Intercontinental Hotel attacked, two gunmen killed...</a>   </li>           <li class="views-row views-row-6 views-row-even">             <a href="http://newsonair.nic.in/news.asp?cat=Business&amp;id=BN4935" target="_BLANK" title="External site that opens in a new window">TRAI recommends allowing mobile, Internet services during air...</a>   </li>           <li class="views-row views-row-7 views-row-odd views-row-last">             <a href="http://newsonair.nic.in/news.asp?cat=State&amp;id=ST2268" target="_BLANK" title="External site that opens in a new window">Former Gujarat CM Anandiben Patel to be next MP Governor</a>   </li>       </ul></div>    </div>                   <div class="view-footer">       <div class="more-link"><a title="More news" href="news_lists852e.html?a56672861">more news..</a></div>    </div>       </div></div></div></div>    </div>                  </div>  </div>  </div>   </div>    <div class="panel-panel panel-col">     <div class="inside"><div class="panel-pane pane-custom pane-2 home_heading no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <h2>Most Requested Information & Forms</h2>    </div>                  </div>  </div>  <div class="panel-separator"></div><div class="panel-pane pane-panels-mini pane-most-view-for-home mostpopular_block accordian no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="panel-display panel-1col clearfix" id="mini-panel-most_view_for_home">   <div class="panel-panel panel-col">     <div><section class="panel-pane pane-views pane-metadata block">    <div class="block-inner clearfix">                      <h2 class="pane-title block-title">Information</h2>                      <div class="block-content">        <div class="view view-metadata view-id-metadata view-display-id-block_1 accordion-container view-dom-id-c8b9322252e3079eaef79220fd17a99f">                      <div class="view-content">       <div class="accordion_body collapsing-section">    <ul>          <li class="views-row views-row-1 views-row-odd views-row-first">     <div>        <span><a href="official-website-small-business-innovation-research-initiative.html">Website of Small Business Innovation Research Initiative</a></span>  </div></li>           <li class="views-row views-row-2 views-row-even">     <div>        <span><a href="official-website-institute-design-electrical-measuring-instruments.html">Website of Institute for Design of Electrical Measuring...</a></span>  </div></li>           <li class="views-row views-row-3 views-row-odd">     <div>        <span><a href="guidelines-central-schemes-soil-and-water-conservation-department-meghalaya.html">Guidelines for central schemes by Soil and Water...</a></span>  </div></li>           <li class="views-row views-row-4 views-row-even">     <div>        <span><a href="official-website-central-translation-bureau.html">Official website of Central Translation Bureau</a></span>  </div></li>           <li class="views-row views-row-5 views-row-odd">     <div>        <span><a href="official-website-centre-marine-living-resources-and-ecology.html">Website of Centre for Marine Living Resources and Ecology</a></span>  </div></li>           <li class="views-row views-row-6 views-row-even">     <div>        <span><a href="central-footwear-training-institute-chennai.html">Central Footwear Training Institute of Chennai</a></span>  </div></li>           <li class="views-row views-row-7 views-row-odd views-row-last">     <div>        <span><a href="official-website-indian-institute-geomagnetism.html">Website of Indian Institute of Geomagnetism</a></span>  </div></li>       </ul></div>    </div>                   </div>    </div>                  </div>  </section>  <div class="panel-separator"></div><section class="panel-pane pane-views pane-metadata block">    <div class="block-inner clearfix">                      <h2 class="pane-title block-title">Forms</h2>                      <div class="block-content">        <div class="view view-metadata view-id-metadata view-display-id-block_1 accordion-container view-dom-id-23bc96e9dbd3a1db43950c661786a796">                      <div class="view-content">       <div class="accordion_body collapsing-section">    <ul>          <li class="views-row views-row-1 views-row-odd views-row-first">     <div>        <span><a href="application-proforma-approval-heritage-buildings-under-grihasthali-scheme.html">Application proforma for approval of heritage buildings...</a></span>  </div></li>           <li class="views-row views-row-2 views-row-even">     <div>        <span><a href="application-form-export-licence-restricted-items.html">Application form for export licence for restricted items</a></span>  </div></li>           <li class="views-row views-row-3 views-row-odd">     <div>        <span><a href="application-form-death-certificate-tirunelveli.html">Application Form for Death Certificate in Tirunelveli</a></span>  </div></li>           <li class="views-row views-row-4 views-row-even">     <div>        <span><a href="application-form-import-restricted-items.html">Application form for import of restricted items</a></span>  </div></li>           <li class="views-row views-row-5 views-row-odd">     <div>        <span><a href="export-licence-special-chemicals-organisms-materials-equipment-and-technologies-items.html">Export licence for special chemicals, organisms, materials...</a></span>  </div></li>           <li class="views-row views-row-6 views-row-even">     <div>        <span><a href="application-form-licence-agriculture-trading-importing-and-marketing.html">Application form for licence for agriculture trading...</a></span>  </div></li>           <li class="views-row views-row-7 views-row-odd views-row-last">     <div>        <span><a href="application-allotment-ravindra-bharathi-stage-and-auditorium-andhra-pradesh.html">Application for allotment of Ravindra Bharathi Stage and...</a></span>  </div></li>       </ul></div>    </div>                   </div>    </div>                  </div>  </section>  </div>   </div> </div>     </div>                  </div>  </div>  </div>   </div>    <div class="panel-panel panel-col-last">     <div class="inside"><div class="panel-pane pane-custom pane-3 home_heading no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <h2>Activities & Initiatives</h2>    </div>                  </div>  </div>  <div class="panel-separator"></div><div class="panel-pane pane-views pane-featured no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="view view-featured view-id-featured view-display-id-block view-dom-id-505e004e144363149572f05d95282e17">                      <div class="view-content">         <div class="views-row views-row-1 views-row-odd views-row-first initiatives-block">          <div class="views-field views-field-field-image">        <div class="field-content"><a href="https://services.india.gov.in/" target="_BLANK" title="The in file Open in new window"><img typeof="foaf:Image" class="image-style-none" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/service-portal.jpg" width="199" height="87" alt="Government Services Portal" title="Government Services Portal" /></a></div>  </div>     <div>        <p>a single window access to services being provided by the various Indian Government entities</p>  </div>  </div>   <div class="views-row views-row-2 views-row-even views-row-last initiatives-block">          <div class="views-field views-field-field-image">        <div class="field-content"><a href="http://ors.gov.in/copp/" target="_BLANK" title="External site that opens in a new window"><img typeof="foaf:Image" class="image-style-none" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/digital-india_1.jpg" width="199" height="87" alt="E-Hostital Health Services Made Easy" /></a></div>  </div>     <div>        <p>Aadhaar based system where counter based hospital OPD registration and appointment system has been made online</p>  </div>  </div>     </div>                   </div>    </div>                  </div>  </div>  </div>   </div> </div>     </div>                  </div>  </div>  <div class="panel-separator"></div>  <div class="panel-separator"></div><div class="panel-pane pane-custom pane-7 wrapper no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <script type="text/javascript"> 	 	$(document).ready(function(){		 		var n_time;		 		refreshCalendar(); 		setInterval( refreshCalendar, 900000); 		function refreshCalendar(){ 			var d = new Date(); 			n_time = d.getTime(); 					 			$(".calendar a").attr("href", $(".calendar a").attr("href")+"?a="+n_time); 		} 	}); </script>    <div class="homebtm_quicklinks"><ul> <li><a href="http://www.goidirectory.gov.in/index.php" target="_BLANK" title="External site that opens in a new window"  role="link"><img alt="quicklink5" src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/quicklinks5.png"><div class="quilcklinks_outer"><h2>GOI Web Directory</h2><p>A one-point source to access all Indian Government Websites at all levels and from all sectors. </p></div></a></li>   <li><a title="External site that opens in a new window" target="_BLANK" href="https://apps.mgov.gov.in/index.jsp" role="link"><img alt="quicklink2" src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/quicklinks2.png"><div class="quilcklinks_outer"><h2>Mobile App Directory</h2><p>Mobile Seva Appstore: National Mobile Governance Initiative by Dept. of Electronics & IT</p></div></a></li>  <li  class="calendar"><a href="calendar.html"  role="link"><img alt="quicklink3" src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/quicklinks3.png"><div class="quilcklinks_outer"><h2>Calendar</h2><p>View holidays as per the circular issued by the Ministry of Personnel, Public Grievances and Pensions.</p></div></a></li>  <li><a href="https://egreetings.gov.in/" target="_BLANK"  role="link" title="External site that opens in a new window"><img alt="quicklink4" src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/quicklinks4.png"><div class="quilcklinks_outer"><h2>E Cards</h2><p>Contemporary and eco-friendly method of sharing greetings on National Holidays and festivals.</p></div></a></li>  <li><a href="http://webcast.gov.in/"  role="link" title="External site that opens in a new window" target="_BLANK"><img alt="quicklink1" src="<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/webcast-icon.png"><div class="quilcklinks_outer"><h2>Webcast Services</h2><p>View live and on demand Webcast of important Goverment events, activities and Live TV Channels</p></div></a></li>  </ul></div>     </div>                  </div>  </div>      </div>   </div> </div>     </div>              </div>
