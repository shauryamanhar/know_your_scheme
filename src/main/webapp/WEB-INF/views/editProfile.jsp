...
function updatePassword(){
    ...
    $.ajax({
    	async: false,
		type: "POST",
		url: "<%= request.getContextPath()%>/edit-profile/editPassword",
		...
		success : function(response) {
			...
			if(msg == "emptyFieldsFailure"){
				...
				$("#errorLoginMsg").text("Password cannot be empty");
				errorMsg = "falsee";
				return false;
			}else if(msg == "success"){
				document.getElementById("errorLoginMsg").style.color = "green";
				$("#errorLoginMsg").text("Password updated");
				errorMsg = "truee";
				return true;
			}else{//failure
				errorMsg = "falsee";
			...
			<!-- !Messages and Help -->
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 <li style = "font-size: 10px; background: none;" class="views-row views-row-1 views-row-odd views-row-first">     
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <span style = "margin-left:50px;"><%=user.getFullName() %></span>
                <a href="<%=request.getContextPath() %>/edit-profile" style = "float:right; font-weight:300; margin-right:50px;">Edit Profile</a>
              </h3>
                </div>
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        ...
                        <td style = "text-align:right;"><%=user.getUsername() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                      <tr>
                        <td style = "text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password</td>
                        <td style = "text-align:right;"><input type = "text" id = "password" name = "password" value = "<%=user.getActualPassword() %>"><input type = "button" onclick = "updatePassword()" value = "update" style = "cursor:pointer; outline: none;"></td>
                      </tr>
                      <tr>
                        <td style = "text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email</td>
                        <td style = "text-align:right;"><a href="mailto:info@support.com"><%=user.getEmail() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                      </tr>
                      <tr>
                        <td style = "text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contact Number</td>
                        <td style = "text-align:right;"><%=user.getMobileNumber() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                    </tbody>
                  </table>
                  <hr>
            ...
            <h3 id = "errorLoginMsg"></h3>
           <div class="panel-footer">
              <a href="edit.html" data-original-title="Edit your profile" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
