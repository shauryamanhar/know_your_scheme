...
function isMyValidForm(){
    ...
    $.ajax({
    	async: false,
		type: "POST",
		url: "<%= request.getContextPath()%>/forget-password-email/validate",
		data: { email: email },
		success : function(response) {
			...
			if(msg == "emptyFieldsFailure"){
				...
				errorMsg = "falsee";
				$("#errorLoginMsg").text("Entered email is not registered on KnowYourScheme");
				return false;
			}else{//failure
				errorMsg = "falsee";
...
<h2>Know Your Scheme</h2>
    ...
    <div class="form-wrap">
		<div class="tabs">
			...
			<h5 style = "margin-top: 80px; text-align:center;"><span class="active" href="#login-tab-content" style = "text-decoration: none;">Enter your Email Id, we will send a one time password reset link to your email id</span></h5>
		</div><!--.tabs-->

		<div class="tabs-content">
			<div id="login-tab-content" class="active">
				<form class="login-form" action="<%=request.getContextPath() %>/password-reset-link-msg" method="post" onsubmit="return isMyValidForm();">
					<input type="email" class="input" id="email" autocomplete="off" placeholder="email" name = "email" required>
