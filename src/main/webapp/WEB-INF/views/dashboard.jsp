			...
			<!-- !Messages and Help -->
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 <ul>
						 <li style = "background-color: #E0E0E0;"><a role="link" href="<%=request.getContextPath() %>/dashboard/Recent">Recent Schemes</a></li>
						 <%
						 ...
						 if(recentSchemes != null){
							 ...
							 for(StatementGovernmentSchemes statementGovernmentScheme : recentSchemes){
								 ...
								 if(statementGovernmentScheme.getSchemeName().trim().equalsIgnoreCase("A")){
						 ...
						 <a href="<%=request.getContextPath()%>/schemes/State-Government/<%=statementGovernmentScheme.getTypeOfScheme()%>/A">
						 CBSE 2018 Sample Papers for Class 12 Download at cbse nic in
						 </a>
						 </span>  
						 </div>
						 </li>
