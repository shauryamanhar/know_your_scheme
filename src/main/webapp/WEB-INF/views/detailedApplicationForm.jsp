...
if(session.getAttribute("knowYourSchemeUser") == null){//knowYourSchemeUser
	
	if(request.getAttribute("applicationForm") != null &&
	   !request.getAttribute("applicationForm").equals("")){
		applicationForm = (ApplicationForms)request.getAttribute("applicationForm");
	}
}else{
	...
	if(request.getAttribute("dashboardUser") != null &&
	   ...
	   request.getAttribute("applicationForm") != null &&
	   !request.getAttribute("applicationForm").equals("")){
    ...
    <div id="main" class="columns clearfix">
      <main id="content-column" class="content-column" role="main">
        ...
        <div class = "container">
            ...
            <article>
            <%=applicationForm.getDetailedInfoPage() %>
            </article>
            </div>
        </div>
