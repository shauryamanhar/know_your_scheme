...
%>
	  ...
	  <!-- !Breadcrumbs -->
		<div class="bread_crumbs" > 
			<div class='wrapper'><a>Visualisation</a></div>		</div> 
        <div class="content-inner wrapper">	
			<!-- !Messages and Help -->
									<div class="full_width_secction" style = "width: 100%;">
			  
								  <h1 class="static_page_head">Visualisations</h1>
					...
					<!-- !Main Content -->
						 ...
						 if(visualisationCategory != null){
							 for(Visualisation schemeCat : visualisationCategory){
								    	 %>
								    	 <li><a href="<%=request.getContextPath()%>/schemes/visualisation/categories/<%=schemeCat.getCategory() %>/<%=schemeCat.getHeadline() %>"><%=schemeCat.getHeadline() %></a></li>
								    	 <%
						     }
						  }
