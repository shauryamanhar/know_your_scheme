<%@page import="com.enggcell.entities.Visualisation"%>
<%
...
<!--[if lt IE 9]>
<script src="https://community.data.gov.in/wp-content/themes/datablog/assets//js/html5.js" type="text/javascript"></script>
<![endif]-->
...
<script type="text/javascript">
	...
	__gaTracker('create', 'UA-74047061-1', 'auto');
...
<script type='text/javascript' src='https://community.data.gov.in/wp-includes/js/jquery/jquery.js?ver=1.12.4'></script>
<script type='text/javascript' src='https://community.data.gov.in/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.4.1'></script>
<script type='text/javascript' src='https://community.data.gov.in/wp-content/plugins/accordion-archive-widget/script.js?ver=4.7.3'></script>
<script type='text/javascript' src='https://community.data.gov.in/wp-content/plugins/cardoza-3d-tag-cloud/jquery.tagcanvas.min.js?ver=4.7.3'></script>
<script type='text/javascript' src='https://community.data.gov.in/wp-content/plugins/wonderplugin-slider/engine/wonderpluginsliderskins.js?ver=4.3'></script>
<script type='text/javascript' src='https://community.data.gov.in/wp-content/plugins/wonderplugin-slider/engine/wonderpluginslider.js?ver=4.3'></script>
	<script type="text/javascript">
	$j = jQuery.noConflict();
...
StatementGovernmentSchemes statementGovernmentScheme = null;
String statementGovernmentSchemeDetailedInfo = null;
String[] relatedVideosUrlArray = null;
...
Visualisation headlineDetailedInfo = null;
List<StatementGovernmentSchemes> recentSchemes = null;
if(session.getAttribute("knowYourSchemeUser") == null){
	
	if(request.getAttribute("headlineDetailedInfo") != null &&
	   !request.getAttribute("headlineDetailedInfo").equals("")){
		headlineDetailedInfo = (Visualisation)request.getAttribute("headlineDetailedInfo");
	}
}else{

	if(request.getAttribute("dashboardUser") != null &&
	   !request.getAttribute("dashboardUser").equals("") &&
	   request.getAttribute("headlineDetailedInfo") != null &&
	   !request.getAttribute("headlineDetailedInfo").equals("")){
    ...
    <div id="main" class="columns clearfix">
      <main id="content-column" class="content-column" role="main">
        ...
        <div class = "container">
            ...
            <%=headlineDetailedInfo.getDetailedInfoPage() %>
            </article>
            
            <br>
            <br>
            <%
            if(!headlineDetailedInfo.getTableData().contains("https://community.data.gov.in")){
            %>
            <img src = '<%=headlineDetailedInfo.getTableData() %>'>
            <%
            }
            %>
            </div>
            <div class = "" style = "float: left; width: 18%; margin-top:-500px;">    
            </div>
        </div>
