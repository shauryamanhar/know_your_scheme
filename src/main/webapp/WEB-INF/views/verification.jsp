...
<div id="main" class="columns clearfix" style = "height:300px;">
...
<br>
        ...
        <div class="content-inner" style = "margin-left:30px;">
        <%
        if(request.getAttribute("alreadySent") != null && !request.getAttribute("alreadySent").equals("")){
        	String alreadySentOrNot = (String)request.getAttribute("alreadySent");
        	if(alreadySentOrNot.equals("true")){
        %>
        <h2>A one time verification link has been already sent to your Email Id, please click on that link to complete your registration</h2>
        <h2>(verification link is valid for only 24 hours)</h2>
        <%
        	}else{
        %>
        <h2>A one time verification link has been sent to your Email Id, please click on that link to complete your registration</h2>
        <h2>(verification link is valid for only 24 hours)</h2>
        <%		
        	}
        }
...
<!-- !Footer -->
  <footer id="footer" class="clearfix" role="contentinfo" style = "position:relative; top:100px;">
