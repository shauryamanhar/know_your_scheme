...
<br>
        ...
        %>
        <h2>A one time Password reset link has been already sent to your Email Id, please click on that link to reset your password</h2>
        <h2>(Password reset link is valid for only 24 hours)</h2>
        <%
        	}else{
        %>
        <h2>A one time Password reset link has been sent to your Email Id, please click on that link to reset your password</h2>
        <h2>(Password reset link is valid for only 24 hours)</h2>
        <%		
        	}
        }
