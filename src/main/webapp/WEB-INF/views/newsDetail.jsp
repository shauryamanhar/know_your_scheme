...
News newsDetailed = null;
if(request.getAttribute("newsDetailed") != null &&
   !request.getAttribute("newsDetailed").equals("")){
	newsDetailed = (News)request.getAttribute("newsDetailed");
}
...
<ul id="nav">
  ...
  <ul>
      <li class="  "><span class="fa fa-pagelines"></span><a href="<%=request.getContextPath() %>/schemes/Central-Government/Rural Schemes">Central Government Schemes</a></li>
      <li><span class="fa fa-paint-brush"></span><a href="<%=request.getContextPath() %>/schemes/Chhattisgarh-Government">Chhattisgarh Government Schemes</a></li>
    </ul>
  </li>
      ...
      <main id="content-column" class="content-column" role="main">
        ...
        <div class = "container">
            ...
            <div style = "font-size:15px;">
               <%=newsDetailed.getDetailedInfoPage() %>
            </div>
            </div>
            </div>
        </div>
        ...
        <%	   
           ...
           <div class = "container" style = "height: 300px;">
               <h3>No Update for now, Stay tuned !</h3>
           </div>
           <%   
           }
