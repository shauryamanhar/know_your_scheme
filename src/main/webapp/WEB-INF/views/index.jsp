...
$(document).ready(function(){
	$("#searchKeyword").keyup(function(){
		//alert($(this).val());
		$.ajax({
	        url: '<%= request.getContextPath()%>/schemes/search/autoComplete',
	        type: 'post',
	        dataType: 'html',
	        data: {
	        	keyword: $(this).val(),
		...
		cache: false,
		beforeSend: function(){
			$("#searchKeyword").css("background","#FFF url(LoaderIcon.gif) no-repeat 165px");
		},
	    success: function (data) {
	        var msg = data;
	        //alert(msg);
	        $("#auto_suggesion").show();
			$("#auto_suggesion").html(data);
...
<li><a href="<%=request.getContextPath() %>/schemes/visualisation/categories" class="loginlinks">Visualisation</a></li>
...
<!-- <div id="auto_suggesion"></div>-->
            ...
            Designation           </label>
                        <div class="views-widget">
          					<div class="form-item form-type-select form-item-term-node-tid-depth">
 								<select id="edit-term-node-tid-depth" name="term_node_tid_depth" class="form-select">
 ...
 <select id="edit-sort-order" name="sort_order" class="form-select"><option value="ASC">Asc</option><option value="DESC" selected="selected">Desc</option></select>
	...
	<section class="sliderportion">
		<div class="">
			<article class="homeslider">
				...
				<div class="region-inner clearfix"><div id="block-views-home-main-slider-block" class="block block-views no-title" ><div class="block-inner clearfix">  
  ...
  <div class="views-field views-field-php">        <span class="field-content"><img src="" id="_9dlO5d9OlWeVIZCG" onclick="" style="cursor:pointer" onload="" ></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-2 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/swadesh-spotlight-.jpg"></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-3 views_slideshow_cycle_hidden views-row-odd">
      
  <div class="views-field views-field-php">        <span class="field-content"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/finance.jpg"></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-4 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/ss_2018.jpg"></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-5 views_slideshow_cycle_hidden views-row-odd">
      
  <div class="views-field views-field-php">        <span class="field-content"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/end-review17.jpg"></span>  </div>  </li>
  <li class="flexslider-views-slideshow-main-frame-row flexslider_views_slideshow_slide views-row-6 views_slideshow_cycle_hidden views-row-even">
      
  <div class="views-field views-field-php">        <span class="field-content"><img title="" alt="" src="<%=request.getContextPath() %>/assets/sites/upload_files/npi/files/pradhan-mantri-awas.jpg"></span>  </div>  </li>
    </ul>
  </div>
</div></div>
      </div>
          ...
          <div id="main-content">
            ...
            <!-- !Main Content -->
               <div id="content" class="region">
                <div id="block-system-main" class="block block-system no-title" >          <div class="one-column at-panel panel-display clearfix" id="home">   <div class="region region-one-main">     <div class="region-inner clearfix">       <div class="panel-pane pane-panels-mini pane-home-main-content wrapper no-title block">    <div class="block-inner clearfix">                                
                <div class="block-content">        
                <div class="panel-display panel-3col clearfix" id="mini-panel-home_main_content">   <div class="panel-panel panel-col-first">     
                <div class="inside"><div class="panel-pane pane-custom pane-1 home_heading no-title block">    <div class="block-inner clearfix">                                
                <div class="block-content">        
                <h2>Recent News</h2>    
                </div>                  
                </div>  
                ...
                <div class="panel-pane pane-block pane-quicktabs-none no-title block">    
                <div class="block-inner clearfix">                                
                <div class="block-content">        <div  id="quicktabs-_none_" class="quicktabs-wrapper quicktabs-style-nostyle"><div class="item-list item-list-q">
                </div><div id="quicktabs-container-_none_" class="quicktabs_main quicktabs-style-nostyle"><div  id="quicktabs-tabpage-_none_-0" class="quicktabs-tabpage"><div class="view view-news-feeds view-id-news_feeds view-display-id-block view-dom-id-f9a4bbc875f56772178fe9a00b3a1087">
                                      
               <div class="view-content" style = "top:0px;">       
               <div class="item-list"> 

<marquee onmouseover="this.stop()" onmouseout="this.start()" direction="up" scrollamount="8" height = "400">
                  <%
                  ...
                  %>
                     <img style = "float:left;" src = "<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/arrow.jpg"><h3 class = ""><div><span><a target = "_blank" href = "<%=news.getNewsLink()%>" style = "color: #424242; font-weight: 100; font-family: sans-serif;"><%=news.getNewsHeadline() %></a></span></div></h3>
                     <hr>
                     <br>
                  ...
                  %>
                   ...
                   <div class="view-footer">       <div class="more-link"><a title="More news" href="<%=request.getContextPath() %>/signin">more news..</a></div>    </div>       </div></div></div></div>    </div>                  </div>  </div>  </div>   </div>    <div class="panel-panel panel-col">     <div class="inside"><div class="panel-pane pane-custom pane-2 home_heading no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        
                   <h2>Latest Applications Forms</h2>    
                   </div>                  
                   </div>  </div>  
                   ...
                   <marquee onmouseover="this.stop()" onmouseout="this.start()" direction="up" scrollamount="6" height = "300">
                  <%
                  ...
                  %>
                     <img style = "float:left;" src = "<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/arrow.jpg"><h3 class = ""><div><span><a target = "_blank" href = "<%=request.getContextPath() %>/schemes/Application-Forms/<%=applicationForm.getApplicationHeadline() %>/<%=applicationForm.getUpdatedDate() %>" style = "color: #424242; font-weight: 100; font-family: sans-serif;"><%=applicationForm.getApplicationHeadline() %></a></span></div></h3>
                     <hr>
                     <br>
                  ...
                  %>
                    ...
                    </div>   </div>    <div class="panel-panel panel-col-last">     <div class="inside"><div class="panel-pane pane-custom pane-3 home_heading no-title block">    <div class="block-inner clearfix">                                
                    <div class="block-content">        
                  ...
                  %>
                     <img style = "float:left;" src = "<%=request.getContextPath() %>/assets/sites/all/themes/adaptivetheme/npi_adaptive/images/arrow.jpg"><h3 class = ""><div><span><a target = "_blank" href = "<%=request.getContextPath() %>/schemes/Government-Jobs/<%=governmentJob.getGovernmentJobHeadline() %>/<%=governmentJob.getUpdatedDate() %>" style = "color: #424242; font-weight: 100; font-family: sans-serif;"><%=governmentJob.getGovernmentJobHeadline() %></a></span></div></h3>
                     <hr>
                     <br>
