...
<li><a href="<%=request.getContextPath() %>/schemes/Government-Websites" class="loginlinks">Important Websites</a></li><li><a href="<%=request.getContextPath() %>/schemes/visualisation/categories" class="loginlinks">Visualisation</a></li>
...
<div id="main" class="columns clearfix">
	  ...
	  <!-- !Breadcrumbs -->
		<div class="bread_crumbs" > 
			<div class='wrapper'><a href="<%=request.getContextPath()%>/">Dashboard</a></div>		</div> 
					...
					<!-- !Main Content -->
						 ...
						 if(listOfUserCategories != null){
							 for(UserCategories userCategory : listOfUserCategories){
								 if(userCategory.getCategory().equalsIgnoreCase(category)){
									 %>
									 <li style = "background-color: #E0E0E0;"><a role="link" href="<%=request.getContextPath()%>/dashboard/<%=userCategory.getCategory()%>">
						 ...
						 <%
						 if(category != null){
							 out.print(typeOfNewsMap.get(category));
						 }
						 %>
						 </span> </h2> 
						 <hr>    
						 ...
						 <a href="<%=request.getContextPath()%>/schemes/<%=statementGovernmentScheme.getTypeOfScheme()%>/<%=statementGovernmentScheme.getSchemeName()%>">
						 <%=statementGovernmentScheme.getSchemeName() %>
						 </a>
						 </span>  
						 </div>
						 </li>
						 ...
						 <div class="views-field views-field-title">        
						 <span class="field-content">
						 <a href="<%=request.getContextPath()%>/schemes/State-Government/<%=statementGovernmentScheme.getTypeOfScheme()%>/<%=statementGovernmentScheme.getSchemeName()%>">
						 <%=statementGovernmentScheme.getSchemeName() %>
						 </a>
						 </span>  
						 </div>
						 ...
						 if(mainSearchResult != null && searchResult != null){
							 for(StatementGovernmentSchemes statementGovernmentScheme : searchResult){
							 //for(StatementGovernmentSchemes statementGovernmentScheme : recentSchemes){
								 if(!mainSearchResult.contains(statementGovernmentScheme)){
								 if(!statementGovernmentScheme.getSchemeName().trim().equals("")){
									 if(statementGovernmentScheme.getTypeOfScheme().equalsIgnoreCase("central-government-schemes")){
									 %>
...
@-webkit-keyframes marquee {
  ...
  100% {
    -webkit-transform: translateY(100vw)
						 ...
						 </div>    </div>                   </div>    </div>                  </div>  </div>  <div class="panel-separator"></div><div class="panel-pane pane-views pane-india-glance-right-side no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="view view-india-glance-right-side view-id-india_glance_right_side view-display-id-block_1  whats-new view-dom-id-2e5682202f9ac9b581f1ccb549f757e7">             <div class="view-header">       <div class="sidebar_head"> <i class="fa fa-bullhorn"></i> <h2>What's New</h2> </div>    </div>                <div class="view-content">       <div class="item-list">    <ul>          <li class="views-row views-row-1 views-row-odd views-row-first">     <div class="views-field views-field-title">        <span class="field-content"><a href="../odisha-state-agriculture-policy.html">Odisha State Agriculture Policy</a></span>  </div></li>           <li class="views-row views-row-2 views-row-even">     <div class="views-field views-field-title">        <span class="field-content"><a href="../agricultural-production-techniques-kharif-2008-odisha.html">Agricultural production techniques Kharif 2008 in Odisha</a></span>  </div></li>           <li class="views-row views-row-3 views-row-odd">     <div class="views-field views-field-title">        <span class="field-content"><a href="../kharif-campaign-survey-odisha.html">Kharif Campaign survey in Odisha</a></span>  </div></li>           <li class="views-row views-row-4 views-row-even">     <div class="views-field views-field-title">        <span class="field-content"><a href="../registration-and-licensing-fishing-craft.html">Registration and Licensing of Fishing Craft</a></span>  </div></li>           <li class="views-row views-row-5 views-row-odd views-row-last">     <div class="views-field views-field-title">        <span class="field-content"><a href="../website-directorate-agriculture-goa.html">Website of Directorate of Agriculture of Goa</a></span>  </div></li>       </ul></div>    </div>                   </div>    </div>                  </div>  </div>      </div>   </div>   </div> <section class="nodes"></section>    </div>					
 					 </div>
															<!-- !Feed Icons -->
										</div>
