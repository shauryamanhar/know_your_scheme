...
GovernmentWebsites governmentWebsites = null;
User user = null;
List<News> news = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	...
	if(request.getAttribute("governmentWebsites") != null &&
	   !request.getAttribute("governmentWebsites").equals("")){
		governmentWebsites = (GovernmentWebsites)request.getAttribute("governmentWebsites");
	}	
}else{
	...
	if(request.getAttribute("dashboardUser") != null &&
	   ...
	   request.getAttribute("governmentWebsites") != null &&
	   !request.getAttribute("governmentWebsites").equals("")){
    ...
    <div id="main" class="columns clearfix">
      <main id="content-column" class="content-column" role="main">
        ...
        <div class = "container">
            ...
            <article>
            <%=governmentWebsites.getDetailedInfoPage() %>
            </article>
            </div>
        </div>
