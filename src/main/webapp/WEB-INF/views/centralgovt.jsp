...
List<String> listOfCentralGovernmentSchemesCategory = null;
List<CentralGovernmentSchemes> listOfCentralGovernmentSchemesByCategory = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	if(request.getAttribute("listOfCentralGovernmentSchemesCategory") != null &&
			   !request.getAttribute("listOfCentralGovernmentSchemesCategory").equals("") &&
			   request.getAttribute("listOfCentralGovernmentSchemesByCategory") != null &&
			   !request.getAttribute("listOfCentralGovernmentSchemesByCategory").equals("") &&
			   request.getAttribute("mainCategory") != null &&
			   !request.getAttribute("mainCategory").equals("")){
				listOfCentralGovernmentSchemesCategory = (List<String>)request.getAttribute("listOfCentralGovernmentSchemesCategory");
				listOfCentralGovernmentSchemesByCategory = (List<CentralGovernmentSchemes>)request.getAttribute("listOfCentralGovernmentSchemesByCategory");
				mainCategory = (String)request.getAttribute("mainCategory");
			}
}else{
	...
	if(request.getAttribute("dashboardUser") != null &&
	   ...
	   request.getAttribute("listOfCentralGovernmentSchemesCategory") != null &&
	   !request.getAttribute("listOfCentralGovernmentSchemesCategory").equals("") &&
	   request.getAttribute("listOfCentralGovernmentSchemesByCategory") != null &&
	   !request.getAttribute("listOfCentralGovernmentSchemesByCategory").equals("") &&
	   request.getAttribute("mainCategory") != null &&
  ...
  <div class="block-content content"><div class="view view-most-search view-id-most_search view-display-id-block view-dom-id-e38b830996d06758e7d3042e35592d38">
	  ...
	  <!-- !Breadcrumbs -->
		<div class="bread_crumbs" > 
			<div class='wrapper'><a href="<%=request.getContextPath() %>/">Home</a><a href="<%=request.getContextPath()%>/schemes/">Schemes</a>Central Government</div>		</div> 
        <div class="content-inner wrapper">	
			<!-- !Messages and Help -->
									<div class="full_width_secction">
			  
								  <h1 class="static_page_head">Central Government</h1>
				  ...
				  <section id="main-content">
					...
					<!-- !Main Content -->
						 ...
						 <div id="block-system-main" class="block block-system no-title" >          <div class="three-25-50-25 at-panel panel-display clearfix" >     <div class="region region-three-25-50-25-first">     <div class="region-inner clearfix">       <div class="panel-pane pane-block pane-npi-utility-left-menu-siblings left_sidebar test2 no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="topic" id="leftside-bar">  					<div class="sidebar_head"><i class="fa fa-sitemap"></i><span> Central Government </span></div>
						 <ul>
						 <%
						 if(listOfCentralGovernmentSchemesCategory != null){
							 for(String centralGovernmentSchemeCategory : listOfCentralGovernmentSchemesCategory){
								 if(centralGovernmentSchemeCategory.equalsIgnoreCase(mainCategory)){
									 %>
									 <li style = "background-color:#eeeeee;"><a role="link" href="<%=request.getContextPath()%>/schemes/Central-Government/<%=centralGovernmentSchemeCategory%>"><%=centralGovernmentSchemeCategory%></a></li>
									 <%
								 }else{
									 %>
									 <li><a role="link" href="<%=request.getContextPath()%>/schemes/Central-Government/<%=centralGovernmentSchemeCategory%>"><%=centralGovernmentSchemeCategory%></a></li>
									 <% 
								 } 
							 }
						 }
					       ...
					       <div class="panel-pane pane-views pane-level2-description no-title block">    
					           <div class="block-inner clearfix">                                
					               <div class="block-content">        
					                   <div class="view view-level2-description view-id-level2_description view-display-id-block view-dom-id-13a1319c0ae258b76bc810598c2e6ecb">                      
					                       <div class="view-content">         
					                           <div class="views-row views-row-1 views-row-odd views-row-first views-row-last">
					                           <h2 class="pagetitle"> <span class="title-main"><%=mainCategory %></span> </h2>
					                           <ul style = "list-style-type: none;">
					                           <%
					                           if(listOfCentralGovernmentSchemesByCategory != null){
					                        	   int i = 1;
					                        	   for(CentralGovernmentSchemes centralGovernmentSchemes : listOfCentralGovernmentSchemesByCategory){
					                        		   %>
					                        		   <li><a href = "<%=request.getContextPath()%>/schemes/Central-Government/<%=centralGovernmentSchemes.getSchemeCategory()%>/<%=centralGovernmentSchemes.getSchemeName()%>"><h1><%=i++ %>. <%=centralGovernmentSchemes.getSchemeName() %></h1></a>
					                        		   <br>
					                        		   <ul style = "list-style-type: none;">
					                        		     <li><a href = "<%=request.getContextPath()%>/schemes/Central-Government/<%=centralGovernmentSchemes.getSchemeCategory()%>/<%=centralGovernmentSchemes.getSchemeName()%>"><h3>Full Information</h3></a></li>
					                        		     <br>
					                        		     <li><a href = ""><h3>Frequently Asked Questions</h3></a></li>
					                        		     <br>
					                        		     <li><a href = ""><h3>Related News</h3></a></li>
					                        		   </ul>
					                        		   </li>
