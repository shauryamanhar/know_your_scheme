...
if(session.getAttribute("knowYourSchemeUser") == null){
	...
	if(request.getAttribute("listOfStateGovernmentSchemesByState") != null &&
	   ...
	   request.getAttribute("statementGovernmentScheme") != null &&
	   !request.getAttribute("statementGovernmentScheme").equals("") &&
	   request.getAttribute("statementGovernmentSchemeDetailedInfo") != null &&
	   !request.getAttribute("statementGovernmentSchemeDetailedInfo").equals("")){
		...
		statementGovernmentSchemeDetailedInfo = (String)request.getAttribute("statementGovernmentSchemeDetailedInfo"); 
		statementGovernmentScheme = (StatementGovernmentSchemes)request.getAttribute("statementGovernmentScheme");
	}
}else{
      ...
      <main id="content-column" class="content-column" role="main">
        <div class="content-inner">
          ...
          <div id="main-content">
           ...
           if(statementGovernmentSchemeDetailedInfo != null){
        %>
        <br>
        <div class = "container">
            <br>
            <h1 style = "width: 70%;"><%=statementGovernmentScheme.getSchemeName().replaceAll("[-+.^:,]", " ") %></h1>
            <br>
            <br>
            <img src = "<%=statementGovernmentScheme.getImageUrl()%>" style = "width:750px; height:450px;">
            <br>
            <br>
            <div id = "content" class = "narrowcolumn">
            <article>
            <%=statementGovernmentSchemeDetailedInfo %>
            </article>
            </div>
            <div class = "" style = "float: left; width: 18%; margin-top:-500px;">
            <h1 style = "position: relative; left: 100px; width: 200;">Related Videos</h1>
            <hr style = "position: relative; left: 100px;">
            <ul style = "list-style-type:none;">
                <%
                relatedVideosUrlArray = statementGovernmentScheme.getVideosUrl().split("####%%%%####&&&&");
                if(relatedVideosUrlArray != null && relatedVideosUrlArray.length != 0){
                	...
                	%>
                	<li>
                	   <iframe class = "showVideo" src="<%=headingUrlSplit[0].replace("watch?v=", "embed/")%>" style = "display:block!important; position: relative; left: 100px; width:200px; height:200px;"></iframe>
                	   <h3 style = "position: relative; left: 100px; width: 200;"><%=headingUrlSplit[1] %></h3>
                	   <br>
                	   <hr style = "position: relative; left: 100px;">
                	</li>
                	<%	
