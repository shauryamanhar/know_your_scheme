...
GovernmentJobs governmentJobs = null;
User user = null;
List<News> news = null;
...
if(session.getAttribute("knowYourSchemeUser") == null){
	...
	if(request.getAttribute("governmentJobs") != null &&
	   !request.getAttribute("governmentJobs").equals("")){
		governmentJobs = (GovernmentJobs)request.getAttribute("governmentJobs");
	}
}else{
	...
	if(request.getAttribute("dashboardUser") != null &&
	   ...
	   request.getAttribute("governmentJobs") != null &&
	   !request.getAttribute("governmentJobs").equals("")){
    ...
    <div id="main" class="columns clearfix">
      <main id="content-column" class="content-column" role="main">
        ...
        <div class = "container">
            ...
            <article>
            <%=governmentJobs.getDetailedInfoPage() %>
            </article>
            </div>
        </div>
